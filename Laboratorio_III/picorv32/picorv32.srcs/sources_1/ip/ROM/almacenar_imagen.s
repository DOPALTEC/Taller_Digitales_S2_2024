...
lui x10, 0x4000  //00040537 //Pasar lui al inicio o se perderá el valor de x10, mover los jumps en base a esto (check)
inicio: //label de inicio                                                                                      
lui x1, 0x200  //000020B7 (Guarda en addr un 0x2000)                                                           (check) 


addi x1,x1,16  //01008093 (Actualiza el valor en x1 a 0x2010)                                                  (check)
sw x0, 0(x1) //0000A023                                                                                        (check)
addi x2, x0, 2 //00200113 (Guarda en x2 un 2 que representa el bit de recepción de la UI de UART)              (check)
addi x3, x0, 0x18 //01800193                                                                                   (check)
...
lw x5, 0(x1) //0000A283 (Carga en x5 el dato recibido)                                                         (check)
and x6, x5, x2 //0022F333 (Guarda en x6 el resultado de la operación AND entre x5 y x2)                        (check) 
...
//lui x8, 0x200  //00002437?                                                                                      (check)
//addi x8,x8,28  //01C40413?                                                                                      (check)
lw x4, 0(x8) //00042203
